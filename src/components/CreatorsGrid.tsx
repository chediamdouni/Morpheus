...
const creatorsData = [
    ...
    {
        name: "Hamasset Fannya",
        image: "/images/Hamasset.png",
        description:
            ...
            {creatorsData.map((creator, i) => {
                ...
                return (
                    ...
                    >
                        ...
                        {/* Content */}
                        <motion.div
                            className="relative z-10 text-right max-w-[80vw] absolute bottom-[6%] right-[6%]"
                            initial="hidden"
                        ...
                        >
                            ...
                            >
                                {creator.name.split(" ").map((word, idx) => (
                                    <motion.span
                                        key={idx}
                            ...
                            >
                                {creator.description.split(" ").map((word, idx) => (
                                    <motion.span
                                        key={idx}
                                        className="inline-block"
                                        variants={fadeInUp}
